...
1. [VirtualBox and ISO Setup](docs/01-virtualbox-iso-setup.md)
2. [Server VM Creation](docs/02-server-vm-creation.md)
3. [DC Promotion](docs/03-dc-promotion.md)
4. [Client VM Creation](docs/04-client-vm-creation.md)
5. [Domain Join](docs/05-domain-join.md)
6. [OUs, Users and Groups](docs/06-ous-users-groups.md)
7. [GPO - Desktop Wallpaper](docs/07-gpo-wallpaper.md)
8. [GPO - Password Policy](docs/08-gpo-password-policy.md)
